...
output "hybrid_agent_id" {
  description = "Hybrid deployment agent ID used by the integration"
  value       = var.hybrid_agent_id
}
...
variable "hybrid_agent_id" {
  type        = string
  description = "ID of an existing hybrid deployment agent that is already running"
}
