...
- [provider] update matia_asset credentials in place (DEV-47063) (#105)

## [0.6.0] - 2026-09-10

### Fixed

- [provider] send the credentials authMethod with each connection (#109)

## [0.5.0] - 2026-09-10

### Fixed

- [provider] preserve asset IDs during in-place updates (#102)

## [0.4.0] - 2026-09-09

### Added

- [provider] accept a public_key on matia_asset credentials (#98)
- [provider] accept database_schemas on matia_asset credentials (#99)

## [0.3.0] - 2026-09-08

### Added

- [provider] add matia_asset for multipurpose Snowflake assets (#95)
